...
const COURSES_DATA = [
  { code: 'TIU-UCS-T214',        title: 'Object Oriented Programming using C++',   duration: '45 Hours', difficulty: 'Beginner',      instructor: 'Dept. of CSE-AI, TIU',    img: '/course-banners/cpp.png' },
...
export default function Home() {
  ...
  return (
    <main>
      ...
      {/* Courses Section */}
      <div id="courses" className="section-header" ref={coursesHeaderRef}>Explore Inspiring Online Courses</div>
      ...
      {/* Features Section */}
      <div id="community" className="section-header">Explore Our Features</div>
