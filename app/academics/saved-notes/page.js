      ...
      <div className="page-content" style={{ background: 'linear-gradient(135deg, #eef2ff 0%, #f5f0ff 50%, #eff6ff 100%)', overflowY: 'auto', height: '100vh' }}>
        ...
        <div style={{ padding: '32px 24px', maxWidth: '1400px', margin: '0 auto', width: '100%' }}>
          ...
          <div style={{ marginBottom: '32px', padding: '0 8px' }}>
            <button
              onClick={() => {
                // The prompt says "while clicking on them they returns to the previous page where the profile pop up will still open"
                // So if we go back to dashboard, we should re-open the profile pop up.
            ...
            <h1 style={{ fontSize: '32px', fontWeight: '800', color: '#1e293b', marginBottom: '8px' }}>My Saved Notes</h1>
            <p style={{ color: '#64748b', fontSize: '16px' }}>Manage and organize all your saved PDF notes by course and module.</p>
          </div>
